;; item L becomes an intermediate product requiring 2M, F and B
;; observe that itemB is already required in the tree by A. It seems like it is a raw material, but it is not. see graph
;; item M, F are added.
;; new workshop is added
(define (problem procurement_problem)
    ...
    (:goal (and (delivered A Customer1) (delivered B Customer2) (delivered C Customer3)) )
)
