...
(:types    itemB itemD itemE itemA itemC itemI itemJ itemK itemL itemN itemM itemF - item
            location
)
...
:parameters(?f - itemF ?i - itemI ?e - itemE ?j - itemJ ?k - itemK ?n - itemN  ?m - itemM ?loc1 - location)
:duration (= ?duration 1)
:condition (and 
                (at start (available))
