...
(:durative-action produce_item_L_1time  
...
:effect (and    (at start (not (available)))
                ...
                (at start (decrease (stock ?b) 1 ) )
                (at end (available))
)
)

(:durative-action produce_item_L_5time  
:parameters(?l - itemL ?m - itemM ?f - itemF ?b - itemB ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_L ?loc1))
...
:effect (and    (at start (not (available)))
                ...
                (at start (decrease (stock ?m) 10 ) )
                (at start (decrease (stock ?f) 5 ) )
                (at start (decrease (stock ?b) 5 ) )
                (at end (available))
)
)

(:durative-action produce_item_L_10time  
:parameters(?l - itemL ?m - itemM ?f - itemF ?b - itemB ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_L ?loc1))
...
(:durative-action produce_item_L_20time  
:parameters(?l - itemL ?m - itemM ?f - itemF ?b - itemB ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_L ?loc1))
...
(:durative-action produce_item_F_1time    
...
:effect (and    (at start (not (available)))
                (at start (increase (stock ?f) 1 ) )
                (at start (decrease (stock ?g) 2 ) )
                (at start (decrease (stock ?h) 3 ) )
                (at end (available))
)
)

(:durative-action produce_item_F_5time    
:parameters(?g - itemG ?h - itemH ?f - itemF ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_F ?loc1))
...
:effect (and    (at start (not (available)))
                (at start (increase (stock ?f) 5 ) )
                (at start (decrease (stock ?g) 10 ) )
                (at start (decrease (stock ?h) 15 ) )
                (at end (available))
)
)

(:durative-action produce_item_F_10time    
:parameters(?g - itemG ?h - itemH ?f - itemF ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_F ?loc1))
...
(:durative-action produce_item_F_20time    
:parameters(?g - itemG ?h - itemH ?f - itemF ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_F ?loc1))
...
(:durative-action produce_item_G_1time  
...
(:durative-action produce_item_G_5time  
:parameters(?e - itemE ?n - itemN ?j - itemJ ?g - itemG ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_G ?loc1))
...
(:durative-action produce_item_G_10time  
:parameters(?e - itemE ?n - itemN ?j - itemJ ?g - itemG ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_G ?loc1))
...
(:durative-action produce_item_G_20time  
:parameters(?e - itemE ?n - itemN ?j - itemJ ?g - itemG ?loc1 - location)
:duration (= ?duration 1)
:condition (and (at start (available))
                (at start (can_produce_G ?loc1))
...
:effect (and    (at start (not (available)))
                ...
                (at start (increase (stock ?m) 1 ))
                (at start (increase (stock ?h) 1 ))                               
                (at end (available))
)
)
...
:effect (and    (at start (not (available)))
                ...
                (at start (increase (stock ?m) 5 ))
                (at start (increase (stock ?h) 5 ))                               
                (at end (available))
)
)
...
:effect (and    (at start (not (available)))
                ...
                (at start (increase (stock ?m) 10 ))
                (at start (increase (stock ?h) 10 ))                               
                (at end (available))
)
)
...
:effect (and    (at start (not (available)))
                ...
                (at start (increase (stock ?m) 20 ))
                (at start (increase (stock ?h) 20 ))                               
                (at end (available))
)
)
