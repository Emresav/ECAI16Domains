;; in addition to terraria_truck domain, this domain requires production of 10 chests. 
;; Each chest requires 8 woods, 2 iron_bars, and 2 lead_bars. 
;; new types  : chest, lead_bar are defined.
;; new action : produce_chests
