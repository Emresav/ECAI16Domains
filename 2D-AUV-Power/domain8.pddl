;; power capacity per glide is decreased from 90 to 75. we should see more glide actions now.
...
:condition (and (at start (can-move))
                ...
                (at start (<= (+ (* ?x_pos 3) (* ?y_pos 4)) 75 )) ;;  power is only needed when gliding up.
